...
test("Testing AddWordToT9 and PredictT9 for words using each number") {
  T9* dict = InitializeEmptyT9();
  // Add valid words
  char* cat = "cat"; //228
  char* dog = "dog"; //364
  ...
  AddWordToT9(dict, cat);
  AddWordToT9(dict, dog);
  AddWordToT9(dict, want);
  AddWordToT9(dict, rut);
  AddWordToT9(dict, jam);

  char* valid_return1 = PredictT9(dict, "228");
  char* valid_return2 = PredictT9(dict, "364");
  char* valid_return3 = PredictT9(dict, "9268");
  char* valid_return4 = PredictT9(dict, "788");
  char* valid_return5 = PredictT9(dict, "526");


  safe_assert(valid_return1 != NULL);
  AssertReturnedStringEquals(cat, valid_return1);
  safe_assert(valid_return2 != NULL);
  AssertReturnedStringEquals(dog, valid_return2);
  safe_assert(valid_return3 != NULL);
  AssertReturnedStringEquals(want, valid_return3);
  safe_assert(valid_return4 != NULL);
  AssertReturnedStringEquals(rut, valid_return4);
  safe_assert(valid_return5 != NULL);
  AssertReturnedStringEquals(jam, valid_return5);
